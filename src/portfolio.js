...
https://fontawesome.com/icons?d=gallery */
  ...
  softwareSkills: [
    ...
    {
      skillName: "powerbuilder",
      fontAwesomeClassname: "fas fa-code"
    },

    {
      skillName: "powerScript",
      fontAwesomeClassname: "fas fa-laptop-code"
    },
    {
      skillName: "postgresql",
      fontAwesomeClassname: "fas fa-database" // temporary or generic icon
    },
    {
      skillName: "SSH",
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "Universidad Católica Nuestra Señora de la Asunción",
    ...
    {
      schoolName: "Universidad Nacional de Asunción",
  ...
  projects: [
    {
      ...
      footerLink: [
        {
          name: "See Project",
          url: "https://github.com/yinaojeda/cenesis/"
        }
  ...
  achievementsCards: [
    {
      ...
      subtitle:
        "I served as a mentor in the Google Code-in 2016",
      image: require("./assets/images/codeInLogo.webp"),
      imageAlt: "Google Code-In Logo",
      footerLink: [
        {
          name: "View Certificate",
          url: "https://drive.google.com/file/d/118iB0HEbwK8BCj6PnODYZLeBJvrx_9ZH/view?usp=sharing"
        },
        /*
        {
          name: "Award Letter",
...
const contactInfo = {
  ...
  number: "+595 994 874 350",
  email_address: "ojeda.yina@gmail.com"
};
